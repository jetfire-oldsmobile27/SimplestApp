...
$QT_HOST_PATH/bin/qt-cmake -S $PROJECT_DIR -B $BUILD_DIR \
    ...
    -DQT_HOST_PATH:FILEPATH=$QT_HOST_PATH\  # NO TRAILING SPACE HERE
    -DANDROID_NDK:PATH=$ANDROID_NDK\  # NO TRAILING SPACE
    -DANDROID_STL:STRING=c++_shared\  # NO TRAILING SPACE
    ...
    -DQT_HOST_PATH:PATH=$QT_HOST_PATH\  # NO TRAILING SPACE
